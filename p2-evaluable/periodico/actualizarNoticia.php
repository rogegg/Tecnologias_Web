				...
				<section class="columnRight">
					<section id="container">
						<h1>Administración de noticias</h1>
					         ...
					         <form action="php/actualizar_noticia.php" method="post" onsubmit="return validarNoticia()">
				            	<section class="form">
				            		<h1> Actualizar Noticia </h1><br>
				            		<input id="tituloOriginal" type="text" name="tituloOriginal" placeholder="Título original" required="yes">
				            		<input id="titulo" type="text" name="titulo" placeholder="Título actualizado de la noticia">
									<textarea id="texto" name="texto" rows="4" cols="70" placeholder="Texto actualizado de la noticia..."></textarea>
					            	<input id="url" type="text" name="url" placeholder="Url de la noticia">
									
									<input class="submit" type="submit" group="1" name="submit" value="Actualizar noticia" />
