					...
					<section id="container">
						<h1>Administración de noticias</h1>
						 <a href="administracion.php"><button type="button">Administración</button></a>
					         <form action="php/insertar_noticia.php" method="post" onsubmit="return validarNoticia()">
				            	<section class="form">
				            		<h1> Noticia Nueva </h1><br>
				            		<input id="titulo" type="text" name="titulo" placeholder="Título de la noticia" required="yes">
									<textarea id="texto" name="texto" rows="4" cols="70" placeholder="Texto de la noticia..."></textarea>
					            	<input id="url" type="text" name="url" placeholder="Url de la noticia">
									
									<input class="submit" type="submit" group="1" name="submit" value="Publicar noticia" />
